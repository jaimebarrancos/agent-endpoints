...
export async function runCreatePositionClient() {
    console.log(`=============================================================`);
    console.log(` Executing /create-position Client (Payer: ${walletB.address})`);
    ...
    try {
        const response = await fetchWithPayment('http://localhost:3000/create-position', {
            method: 'POST',
        ...
        console.log('\n[Client] Received Non-Custodial Position Creation Plan:');
        ...
        if (Array.isArray(data?.preparedTransactions) && data.preparedTransactions.length > 0) {
            ...
            console.log(`\n=============================================================`);
            console.log(` [Client] All Position Creation Transactions Successfully Executed!`);
            console.log(`=============================================================`);
        }
    } catch (err: any) {
