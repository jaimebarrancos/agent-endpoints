...
export const SUBGRAPH_URL_MAINNET = `https://gateway.thegraph.com/api/${process.env.SUBGRAPH_API_KEY || ''}/subgraphs/id/43Hwfi3dJSoGpyas9VwNoDAv55yjgGrPpNSmbQZArzMG`;
...
export const SUBGRAPH_URL_TESTNET = 'https://api.studio.thegraph.com/query/48043/uniswap-v3-base-sepolia/version/latest';
